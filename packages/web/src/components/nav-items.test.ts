 ...
 *  gate owns ONLY its own item, and all default to absent while health is unknown. */
describe('visibleNavItems', () => {
  ...
  it('without a forge, the GitHub item drops out', () => {
  ...
  it('drops both when nothing is available', () => {
