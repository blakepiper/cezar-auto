 ...
 * It cycles rather than opening a menu: four states, one target, no popover to hit on mobile.
...
const ICON = { light: SunIcon, dark: MoonIcon, system: MonitorIcon, lazyvim: PaletteIcon } as const
const LABEL: Record<Theme, string> = { light: 'light', dark: 'dark', system: 'system', lazyvim: 'LazyVim' }
